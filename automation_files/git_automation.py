...
driver = Edge(executable_path="D:\\MyOwnPython Projects\\J.A.R.V.I.S-by-Swayam\\automation_files\\msedgedriver.exe", options=edge_options)
...
def start_uploading():
    ...
    if "https://github.com" == driver.current_url:
        ...
        driver.find_element_by_xpath(
            "/html/body/div[6]/main/div/form/div[2]/auto-check/dl/dd/input").send_keys(ProjectName)

        time.sleep(0.8)
        # then our bot will click on the create Repository button
        driver.find_element_by_xpath(
            "/html/body/div[6]/main/div/form/div[4]/button").click()
        ...
        driver.find_element_by_xpath(
            "/html/body/div[6]/div/main/div[2]/div/git-clone-help/div[1]/div/div[4]/div/span/span/clipboard-copy").click()
